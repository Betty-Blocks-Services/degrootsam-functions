...
const getAllowedKindsByTypes_1 = require("../../../helpers/getAllowedKindsByTypes");
const { allowedKinds, allowedInputKinds } = getAllowedKindsByTypes_1.getAllowedKindsByType('radio');
exports.options = {
