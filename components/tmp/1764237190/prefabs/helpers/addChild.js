...
const getAllowedKindsByType_1 = require("./getAllowedKindsByType");
exports.addChildOptions = (type) => {
    const { actionInputVariableKind, allowedKinds, allowedInputKinds } = getAllowedKindsByType_1.getAllowedKindsByType(type);
